...
public class V1_10 extends NMSWrapper {
    ...
    public V1_10() {
        try {
            ...
            entityCountField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("entityCount");
            dataWatcherByteField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("aa");
            dataWatcherCustomNameField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("aA");
            dataWatcherCustomNameVisibleField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("aB");
            dataWatcherSilentField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("aC");
            dataWatcherNoGravityField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("aD");
    ...
    public Component getEntityDisplayName(Entity entity) {
        ...
        return GsonComponentSerializer.gson().deserialize(IChatBaseComponent.ChatSerializer.a(customName));
    }
    ...
    public Entity getEntityFromID(World world, int id) {
        ...
        net.minecraft.server.v1_10_R1.Entity entity = worldServer.getEntity(id);
    ...
    public Entity getEntityFromUUID(UUID uuid) {
        for (World world : Bukkit.getWorlds()) {
            WorldServer worldServer = ((CraftWorld) world).getHandle();
            net.minecraft.server.v1_10_R1.Entity entity = worldServer.getEntity(uuid);
            if (entity != null) {
    ...
    public PacketContainer[] createSpawnDamageIndicatorPackets(int entityId, UUID uuid, Component entityNameComponent, Location location, Vector velocity, boolean gravity) {
        try {
            ...
            spawnEntityLivingPacketFields[2].setInt(packet1, EntityType.ARMOR_STAND.getTypeId());
