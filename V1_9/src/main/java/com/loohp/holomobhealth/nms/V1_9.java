...
public class V1_9 extends NMSWrapper {
    ...
    public V1_9() {
        try {
            ...
            entityCountField = net.minecraft.server.v1_9_R1.Entity.class.getDeclaredField("entityCount");
            dataWatcherByteField = net.minecraft.server.v1_9_R1.Entity.class.getDeclaredField("ax");
            dataWatcherCustomNameField = net.minecraft.server.v1_9_R1.Entity.class.getDeclaredField("az");
            dataWatcherCustomNameVisibleField = net.minecraft.server.v1_9_R1.Entity.class.getDeclaredField("aA");
            dataWatcherSilentField = net.minecraft.server.v1_9_R1.Entity.class.getDeclaredField("aB");
