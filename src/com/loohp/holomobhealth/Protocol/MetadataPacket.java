...
public class MetadataPacket {
	...
	public static void sendMetadataPacket(Entity entity, String entityName, boolean visible) {
		String name = entityName != null ? (entityName.equals("") ? null : entityName) : entityName;
