...
public class V1_11 extends NMSWrapper {
    ...
    public V1_11() {
        try {
            ...
            entityCountField = net.minecraft.server.v1_11_R1.Entity.class.getDeclaredField("entityCount");
            dataWatcherByteField = net.minecraft.server.v1_11_R1.Entity.class.getDeclaredField("Z");
            dataWatcherCustomNameField = net.minecraft.server.v1_11_R1.Entity.class.getDeclaredField("aA");
            dataWatcherCustomNameVisibleField = net.minecraft.server.v1_11_R1.Entity.class.getDeclaredField("aB");
            dataWatcherSilentField = net.minecraft.server.v1_11_R1.Entity.class.getDeclaredField("aC");
            dataWatcherNoGravityField = net.minecraft.server.v1_11_R1.Entity.class.getDeclaredField("aD");
    ...
    public Entity getEntityFromID(World world, int id) {
        ...
        net.minecraft.server.v1_11_R1.Entity entity = worldServer.getEntity(id);
    ...
    public Entity getEntityFromUUID(UUID uuid) {
        for (World world : Bukkit.getWorlds()) {
            WorldServer worldServer = ((CraftWorld) world).getHandle();
            net.minecraft.server.v1_11_R1.Entity entity = worldServer.getEntity(uuid);
            if (entity != null) {
