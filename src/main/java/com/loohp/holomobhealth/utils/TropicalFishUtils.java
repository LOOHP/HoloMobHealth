        ...
        if (!HoloMobHealth.version.isLegacy()) {
            try {
                ...
                getTropicalFishVarianceMethod = NMSUtils.reflectiveLookup(Method.class, () -> {
                    ...
                    Method method = nmsEntityTropicalFishClass.getMethod("gq");
                    if (!method.getReturnType().equals(int.class)) {
                        throw new NoSuchMethodException("Incorrect return type");
                    }
                    return method;
                }, () -> {
                    Method method = nmsEntityTropicalFishClass.getMethod("gp");
                    if (!method.getReturnType().equals(int.class)) {
                        throw new NoSuchMethodException("Incorrect return type");
                    }
                    return method;
                    ...
                    Method method = nmsEntityTropicalFishClass.getMethod("fS");
                    if (!method.getReturnType().equals(int.class)) {
                        throw new NoSuchMethodException("Incorrect return type");
                    }
                    return method;
                }, () -> {
                    Method method = nmsEntityTropicalFishClass.getMethod("fY");
                    if (!method.getReturnType().equals(int.class)) {
                        throw new NoSuchMethodException("Incorrect return type");
                    }
                    return method;
                }, () -> {
                    Method method = nmsEntityTropicalFishClass.getMethod("ge");
                    if (!method.getReturnType().equals(int.class)) {
                        throw new NoSuchMethodException("Incorrect return type");
                    }
                    return method;
