...
public class V1_14 extends NMSWrapper {
    ...
    public UUID getEntityUUIDFromID(World world, int id) {
        ...
        net.minecraft.server.v1_14_R1.Entity entity = worldServer.getEntity(id);
    ...
    public Entity getEntityFromUUID(UUID uuid) {
        for (World world : Bukkit.getWorlds()) {
            WorldServer worldServer = ((CraftWorld) world).getHandle();
            net.minecraft.server.v1_14_R1.Entity entity = worldServer.getEntity(uuid);
            if (entity != null) {
    ...
    public DataWatcherFields getDataWatcherFields() {
        try {
            ...
            return new DataWatcherFields(
                    ...
                    new DataWatcherField(EntityArmorStand.b.a(), DataWatcherFieldType.BYTE)
            );
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        }
