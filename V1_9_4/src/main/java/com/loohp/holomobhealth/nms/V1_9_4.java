...
public class V1_9_4 extends NMSWrapper {
    ...
    public V1_9_4() {
        try {
            ...
            entityCountField = net.minecraft.server.v1_9_R2.Entity.class.getDeclaredField("entityCount");
            dataWatcherByteField = net.minecraft.server.v1_9_R2.Entity.class.getDeclaredField("ay");
            dataWatcherCustomNameField = net.minecraft.server.v1_9_R2.Entity.class.getDeclaredField("aA");
            dataWatcherCustomNameVisibleField = net.minecraft.server.v1_9_R2.Entity.class.getDeclaredField("aB");
            dataWatcherSilentField = net.minecraft.server.v1_9_R2.Entity.class.getDeclaredField("aC");
